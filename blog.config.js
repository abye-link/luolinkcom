// 注: process.env.XX是Vercel的环境变量，配置方式见：https://docs.luolink.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a
...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Luolink', // 您的昵称 例如 luolink
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://luolink.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'luolink的博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '皖ICP备2023007862号-1', // 备案号 闽ICP备XXXXXXX
