...
const CONFIG = {
    ...
    PROXIO_HERO_BUTTON_2_URL: 'https://github.com/luolink/NotionNext', // 英雄区按钮
    ...
    PROXIO_FEATURE_BUTTON_URL: 'https://github.com/luolink/NotionNext', // 按钮跳转
    ...
    PROXIO_FAQS: [
        { q: 'NotionNext有帮助文档吗？', a: 'NotionNext提供了<a href="https://docs.luolink.com/about" className="underline">帮助文档</a>，操作<a href="https://www.bilibili.com/video/BV1fM4y1L7Qi/" className="underline">演示视频</a>，以及<a href="https://docs.luolink.com/article/chat-community" className="underline">交流社群</a>来协助您完成网站的搭建部署' },
        { q: '部署后要如何编写文章？', a: '您可以在Notion中之间添加或修改类型为Post的页面，内容将被实时同步在站点中，详情参考<a className="underline" href="https://docs.luolink.com/article/start-to-write">《帮助文档》</a>' },
    ...
    PROXIO_FOOTER_LINKS: [
        {
            ...
            menus: [
                {
                    title: 'Tangly的学习笔记',
                    href: 'https://blog.luolink.com'
                },
                {
                    title: 'NotionNext',
                    href: 'https://www.luolink.com'
                }
            ]
        },
        {
            name: '开发者',
            menus: [
                { title: 'Github', href: 'https://github.com/luolink/NotionNext' },
                {
                    title: '开发帮助',
                    href: 'https://docs.luolink.com/article/how-to-develop-with-notion-next'
                },
                {
                    title: '功能反馈',
                    href: 'https://github.com/luolink/NotionNext/issues/new/choose'
                },
                {
                    title: '技术讨论',
                    href: 'https://github.com/luolink/NotionNext/discussions'
                },
                {
                    title: '关于作者',
                    href: 'https://blog.luolink.com/about'
                }
            ]
        }],
    ...
    PROXIO_POST_REDIRECT_URL: 'https://blog.luolink.com', // 重定向域名
    PROXIO_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_PROXIO_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://docs.luolink.com/article/notion-next-mailchimp
}
