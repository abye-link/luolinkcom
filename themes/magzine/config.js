const CONFIG = {
  ...
  MAGZINE_SOCIAL_CARD_URL: 'https://docs.luolink.com/article/chat-community',
  ...
  MAGZINE_FOOTER_LINKS: [
    ...
    },
    {
      ...
      menus: [
        {
          title: '站长社群',
          href: 'https://docs.luolink.com/article/chat-community'
        },
        {
          title: '咨询与定制',
          href: 'https://docs.luolink.com/article/my-service'
        },
        {
          title: '升级手册',
          href: 'https://docs.luolink.com/article/my-service'
        ...
        {
          title: '安装教程',
          href: 'https://docs.luolink.com/article/how-to-update-notionnext'
        },
        { title: 'SEO推广', href: 'https://seo.luolink.com/' }
      ]
    },
    {
      name: '解决方案',
      menus: [
        { title: '建站工具', href: 'https://www.luolink.com/' },
        { title: 'NotionNext', href: 'https://docs.luolink.com/about' }
      ]
    }
  ],
